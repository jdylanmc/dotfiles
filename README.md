...
`home/.config/herdr/config.toml` tracks the complete default configuration
generated by `herdr --default-config`. The installer links it to
`~/.config/herdr/config.toml` and runs:
