...
| `~/.config/starship.toml` | Authored, current | Generated from Starship's Nerd Font Symbols preset, tracked as the shared shell prompt configuration, and linked into place by the installer. |
